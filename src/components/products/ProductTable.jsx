...
function EnhancedTableToolbar(props) {
  const { numSelected, handleAddProduct } = props;
...
export default function ProductTable() {
  const { getAllItems, addNewProduct } = React.useContext(ProductContext);
  ...
  const handleSubmit = (e) => {
   ...
   addNewProduct(newProduct); // Use context method to add the new product
   handleClose();
  };
